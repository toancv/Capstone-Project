...
insert into Admin values('truong', '123456', 'Truong', 'Tran Nhat', '1', '13/3/1995','0978203753', null, 'truongntse03527@fpt.edu.vn','Ha Noi' )
...
insert into Trainer values ('6', '3')
...
insert into Document values((SELECT * FROM OPENROWSET(BULK N'https://marketplace.canva.com/MAB6okiUZCo/1/0/thumbnail_large/canva-monochromatic-membership-certificate-MAB6okiUZCo.jpg', SINGLE_BLOB) as UserPicture ), 'thac si', '2', '1')
insert into Document values((SELECT * FROM OPENROWSET(BULK N'http://coastcopy.ca/wp/wp-content/uploads/certificate-2.jpg', SINGLE_BLOB) as UserPicture ), 'thac si', '4', '1')
insert into Document values((SELECT * FROM OPENROWSET(BULK N'https://csedweek.org/images/hour_of_code_certificate.jpg', SINGLE_BLOB) as UserPicture ), 'thac si', '1', '1')
insert into Document values((SELECT * FROM OPENROWSET(BULK N'https://images.template.net/wp-content/uploads/2015/06/Sample-Graphic-Designer-Certificate.jpg', SINGLE_BLOB) as UserPicture ), 'thac si', '6', '1')
insert into Document values((SELECT * FROM OPENROWSET(BULK N'https://marketplace.canva.com/MAB4r0J_cRY/1/0/thumbnail_large/canva-college-diploma-certificate-MAB4r0J_cRY.jpg', SINGLE_BLOB) as UserPicture ), 'thac si', '6', '1')
insert into Document values((SELECT * FROM OPENROWSET(BULK N'http://www.education.pa.gov/PublishingImages/Certificate.jpg', SINGLE_BLOB) as UserPicture ), 'thac si', '5', '1')
insert into Document values((SELECT * FROM OPENROWSET(BULK N'http://cdn.hloom.com/images/Employee-Of-The-Month-Recognition-Certificate.jpg', SINGLE_BLOB) as UserPicture ), 'thac si', '2', '1')
insert into Document values((SELECT * FROM OPENROWSET(BULK N'https://www.typing.com/dist/site/images/elements/certificate.jpg', SINGLE_BLOB) as UserPicture ), 'thac si', '1', '1')
insert into Document values((SELECT * FROM OPENROWSET(BULK N'https://hbphelp.zendesk.com/hc/en-us/article_attachments/203875838/7.png', SINGLE_BLOB) as UserPicture ), 'thac si', '3', '1')
insert into Document values((SELECT * FROM OPENROWSET(BULK N'https://s-media-cache-ak0.pinimg.com/originals/e5/b1/7e/e5b17e19e89cb409512ad80db7fb83be.jpg', SINGLE_BLOB) as UserPicture ), 'thac si', '4', '0')
insert into Document values((SELECT * FROM OPENROWSET(BULK N'http://www.aviakom.ru/images/sertificats/nist_big.gif', SINGLE_BLOB) as UserPicture ), 'thac si', '1', '1')
insert into Document values((SELECT * FROM OPENROWSET(BULK N'https://cmes.arizona.edu/sites/cmes.arizona.edu/files/Snip%20of%20sample%20certificate.PNG', SINGLE_BLOB) as UserPicture ), 'thac si', '5', '1')
insert into Document values((SELECT * FROM OPENROWSET(BULK N'http://www.certificatestemplate.com/wp-content/uploads/2016/05/Award-Certificates-pdf-download.jpg', SINGLE_BLOB) as UserPicture ), 'thac si', '2', '1')
insert into Document values((SELECT * FROM OPENROWSET(BULK N'http://www.wordmstemplates.com/wp-content/uploads/2015/09/Certificate-of-Completion-template-7854.jpg', SINGLE_BLOB) as UserPicture ), 'thac si', '4', '0')
insert into Document values((SELECT * FROM OPENROWSET(BULK N'https://suzukiassociation.org/images/1280x960/products/graduation-certificate.jpg', SINGLE_BLOB) as UserPicture ), 'thac si', '3', '1')

/* insert into History table */
/* CourseID, LearnerID, Time, isSaved */

insert into History values('2', '1', getdate(), '1')
insert into History values('5', '1', getdate(), '1')
insert into History values('9', '1', getdate(), '1')
insert into History values('1', '1', getdate(), '1')
insert into History values('4', '1', getdate(), '1')
...
insert into Leaner values('2')
insert into Leaner values('3')
insert into Leaner values('4')
